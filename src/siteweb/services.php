...
<html>
	<head>
		<title>Nos services | MARKET 3W Agence webmarketing spécialisé en référencement</title>
					...
					<section class="wrapper style4 container">
						...
						<!-- Content -->
							<div class="content">
                                ...
                                - Le développement de votre chiffre d'affaire, l'acquisition de contacts qualifiés<br/><br/></td></tr>
                                <tr>
                                <tr><td style="font-weight:500;">Nos solutions</td></tr>
                                <tr><td>- Une solution évolutive basée sur l'analyse des données et des résultats obtenus, les évolutions de l'environnement technologique, l'évolution de vos besoins<br/>
-  Un interlocuteur unique et une équipe d'experts dédiée <br/>
- L'utilisation de ressources, de logiciels d'analyse et de techniques à la pointe de la technologie<br/><div id="sea"></div>
- Une solution d'accompagnement complète, sur-mesure, orientée performance et ROI !</td></tr>
                                <tr>
                                </table>
...
<h1 style="font-weight:500;">Référencement payant (SEA)</h1>
                                ...
                                - Diminuer les coûts d'acquisition<br/>
                                - Obtenir un retour sur investissement rapide et optimal<br/><br/></td></tr>
                                <tr>
                                <tr><td style="font-weight:500;">Nos solutions</td></tr>
                                <tr><td>
                                - Définition  des objectifs<br/>
                                - Analyse de la concurrence<br/>
                                - Création ou reprise des campagnes<br/>
                                - Utilisation de mots-clés qualifiés<br/>
                                - Création de groupes d'annonces spécifiques<br/>
                                - Rédaction d'annonces spécifiques et efficaces<br/>
                                - Usage d'URLs spécifiques<br/>
                                - Options de ciblage (Expression large, exacte, mots-clés négatifs)<br/>
                                - Planification horaire des annonces<br/>
                                - Emploi du réseau de contenu Google<br/>
                                - Ciblage géographique et démographique<br/>
                                ...
                                <div id="smo"></div>
                                - Optimisation et développement des campagnes</td></tr>
                                <tr>
                                </table>
...
<h1 style="font-weight:500;">Référencement social (SMO)</h1>
                                ...
                                <tr><td style="font-weight:500;">Nos solutions</td></tr>
                                <tr><td>
                               - Renforcer votre relation client<br/>
   - Construire et préserver votre image de marque (e-réputation)<br/>
   - Fédérer une communauté de prescripteurs <br/>
   - Formation sur l'optimisation de vos pages réseaux sociaux (Facebook, Twitter, Google plus ...)</td></tr>
                                <tr>
                                </table>

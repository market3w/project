	...
	public function post_user($data){
		...
		if($error===false){
			...
			switch($error["errorMessage"]){
				...
				case "Enter 2 same passwords" :      		$_SESSION["errorMessage"] = "Vous n'avez pas indiqu� le meme mot de passe ";
														   break;
        ...
        if($error===false){
            ...
            switch($error["errorMessage"]){
                case "you are not logged" :
                        $_SESSION["errorMessage"] = "Vous n'etes pas connect�";
                        break;
                ...
                case "param 'user_firstname' undefined" :     
                        $_SESSION["errorMessage"] = "Veuillez renseigner votre pr�nom";
                        break;

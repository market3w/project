  ...
  <div class="main-inner">
    <div class="container">
      <div class="row"  style="margin-left:-25px;">
     	...
     	<?php if($currentuser_role_id!=1 && $currentuser_role_id!=2){ ?>
        <div class="span12">
	      	<div id="target-1" class="widget">
	      		<div class="widget-content">
	      			<h1 style="margin-bottom:10px;color:#80B3CA;">Rendez-vous</h1>
			      		
			      	<p>Market3w a mis en place un système de vidéo-conférence sophistiqué afin de vous éviter certains déplacements. Vous pouvez prendre rendez-vous avec l'un de nos webmarketeurs spécialisés dans le référencement afin d'établir un devis, de poser vos quesions ou pour toute autre demande.

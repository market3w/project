...
class AppointmentsTest extends TestMaster {
    ...
    public function setUp() {
        $this->object = new Client_Controllers_Appointments;
    }
    ...
    /**
     * @covers Client_Controllers_Appointments::get_allappointment
    ...
    public function testPost_appointment() {
        $res = $this->object->add_appointment(array("appointment_name"=>"test rdv", "appointment_description"=>"test rdv", "appointment_start_date"=>"2014-09-10", "appointment_start_hour"=>"10:00:00", "appointment_end_date"=>"2014-09-10", "appointment_end_hour"=>"12:00:00", "type_id"=>1));
        $this->assertFalse($res->apiError);
        $this->assertEquals('',$res->apiErrorMessage);
        $this->assertFalse($res->serverError);
        $this->assertEquals('',$res->serverErrorMessage);
    ...
    public function testPut_appointment() {
        $res = $this->object->edit_appointment(array("appointment_id"=>1, "appointment_name"=>"test rdv", "appointment_description"=>"test rdv", "appointment_start_date"=>"10/09/14", "appointment_start_hour"=>"10:00:00", "appointment_end_date"=>"11/09/14", "appointment_end_hour"=>"12:00:00", "type_id"=>2));
        $this->assertFalse($res->apiError);
        $this->assertEquals('',$res->apiErrorMessage);
        $this->assertFalse($res->serverError);
        $this->assertEquals('',$res->serverErrorMessage);
    ...
    public function testDelete_appointment() {
        $res = $this->object->cancel_appointment(array("appointment_id"=>1));
        $this->assertFalse($res->apiError);
        $this->assertEquals('',$res->apiErrorMessage);
        $this->assertFalse($res->serverError);
        $this->assertEquals('',$res->serverErrorMessage);
